    ...
    <div class="container">
        ...
        <form method="POST" action="">
            ...
            <div class="mb-3">
                ...
                <input type="datetime-local" class="form-control" name="tgl_periksa" value="<?php echo $tgl_periksa; ?>"
                    required>
            </div>
            <div class="mb-3">
                <label for="inputCatatan" class="form-label">Catatan</label>
                <textarea class="form-control" name="catatan"="3" placeholder="catatan"
                    required><?php echo $catatan; ?></textarea>
            </div>
            <div class="mb-3">
