...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Jadwal Periksa Pasien</h1>
            </div>
            <div class="col-sm-6">
             ...
             <button type="button" class="btn btn-sm btn-success" data-toggle="modal"
                                data-target="#addModal">Tambah Jadwal Periksa</button>

                            <!-- Button untuk Modal Lihat Jadwal -->
                            <button type="button" class="btn btn-sm btn-info" data-toggle="modal"
                                data-target="#cekJadwal">Lihat Jadwal</button>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card shadow-lg">
                    ...
                    <!-- Modal Lihat Jadwal -->
                    <div class="modal fade" id="cekJadwal" tabindex="-1" role="dialog" aria-labelledby="cekJadwalLabel"
                        aria-hidden="true">
                    ...
                    <div class="card-body table-responsive p-0">
                        <table class="table table-striped">
                            ...
                            $result = mysqli_query($mysqli, $query);
                                while ($data = mysqli_fetch_assoc($result)) {
                                    $status = $data['aktif'] == '1' ? 'Aktif' : 'Tidak Aktif';
                                    $badgeClass = $data['aktif'] == '1' ? 'badge-warning' : 'badge-secondary';
                                    ?>
                                    <tr>
                                        <td><?php echo $no++; ?></td>
                                        <td><?php echo $data['nama']; ?></td>
                                        ...
                                        <td class="text-center align-middle">
                                            <span class="badge badge <?php echo $badgeClass; ?>"
                                                style="font-size: 12px; padding: 5px ; width: 80px;">
                                                <?php echo $status; ?>
                                            </span>
                                        </td>
                                        <td>
                                                    ...
                                                    <form action="page/jadwalPeriksa/updateJadwal.php" method="POST">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="time" class="form-control" id="jamMulai"
                                                                name="jamMulai" value="<?php echo $data['jam_mulai']; ?>"
                                                                required>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="time" class="form-control" id="jamSelesai"
                                                                name="jamSelesai"
                                                                value="<?php echo $data['jam_selesai']; ?>" required>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" id="aktif" name="aktif" required>
                                                                ...
                                                                <option value="2" <?php echo $data['aktif'] == '2' ? 'selected' : ''; ?>>Tidak Aktif</option>
                                                            </select>
                                                        </div>
